...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        KC_TAB,         KC_F,    KC_L,    KC_H,    KC_V,    KC_Z,    XXXXXXX, XXXXXXX, KC_Q,    KC_W,    KC_U,    KC_O,    KC_Y,    KC_SCLN,
    ...
    [7] = LAYOUT(
        KC_CAPS,KC_F1  ,KC_F2  ,KC_F3  ,KC_F4  ,KC_F13 , _______,_______, _______,KC_HOME,KC_UP  ,KC_END ,KC_PGUP,KC_DEL ,
        _______,KC_F5  ,KC_F6  ,KC_F7  ,KC_F8  ,KC_F14 , _______,_______, _______,KC_LEFT,KC_DOWN,KC_RGHT,KC_PGDN,_______,
        _______,KC_F9  ,KC_F10 ,KC_F11 ,KC_F12 ,KC_F15 , _______,_______, _______,KC_PSCR,KC_SCRL,KC_PAUS,KC_INS ,_______,
                                _______,_______,KC_DEL ,_______,  _______,RSFT_T(KC_APP) ,MO(8)  ,_______
    ),

    [8] = LAYOUT(
        _______,_______,_______,_______,_______,_______, _______,_______, _______,KC_BTN1,KC_MS_U,KC_BTN2,KC_WH_U,_______,
        _______,DF(0)  ,DF(1)  ,DF(2)  ,DF(3)  ,_______, _______,_______, KC_BTN3,KC_MS_L,KC_MS_D,KC_MS_R,KC_WH_D,_______,
        _______,TG(5)  ,_______,_______,_______,_______, _______,_______, _______,KC_WH_L,_______,KC_WH_R,_______,_______,
                                _______,_______,_______,_______,  _______,_______,_______,_______
    ),
