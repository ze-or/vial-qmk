...
[7] = LAYOUT_all( /* Navigation */
    _______, _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,          KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 , _______,
    DF(3)  , _______, KC_BTN2, KC_MS_U, KC_BTN1, KC_WH_U, _______,          _______, _______, KC_HOME, KC_UP  , KC_END , KC_PGUP, _______,
    _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, _______,          _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,
